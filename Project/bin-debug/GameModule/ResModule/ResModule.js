...
var ResModule = (function (_super) {
    ...
    ResModule.prototype.StartLoadResource = function () {
        this.LoadResource();
    };
    ...
    ResModule.prototype.CreateBitmap = function (key, posx, posy, parent, anchor) {
    ...
    ResModule.prototype.CreateParticleByKey = function (key) {
        var textureName = key + "_png";
        var jsonName = key;
        return this.CreateParticle(textureName, jsonName);
    };
    ResModule.prototype.CreateParticle = function (textureName, jsonName) {
    ...
    ResModule.prototype.CreateBitmapText = function (fontName) {
